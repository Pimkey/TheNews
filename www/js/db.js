...
function saveSettings(settings) {
  ...
  if (document.getElementById('successMessage') == null) {
    var successMessage = '<div style="background-color: lightgreen; font-size: 20px; color: white; text-align: center" id="successMessage">saved</div>';
    $('#settingnav').after(successMessage);
  }
}
...
function changeColors(color) {
  console.log($('#navmenu'));
  $("#settingnav").css("background", color);
  $(".ui-footer").css("background", color);
}
